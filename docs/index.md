...
[Yung-Hsuan](https://yunghsuanwu.com/) is a social studies researcher on AI dedicated to portraying the co-constitutive relationship between technology and society. He works as an algorithmic auditor [Eticas](https://eticas.ai/), investigating the disparate effects of algorithmic systems on marginalized groups of people. He documents his adventure on [Substack](https://embeddedsociologist.substack.com/) and [Medium](https://medium.com/livres-se). Outside of research, he purposefully gets lost in different parts of the city, meets people and writes them into stories, and works on secret side projects. See more of his work [here](https://linktr.ee/yunghsuanwu).
