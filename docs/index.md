...
[Yung-Hsuan](https://yunghsuanwu.com/) is a social studies researcher on AI dedicated to portraying the co-constitutive relationship between technology and society. He works as an algorithmic auditor at [Eticas](https://eticas.ai/), investigating the disparate effects of algorithmic systems on marginalized communities. Outside of research, he likes roaming around the city aimlessly, writes people around him into stories, and works on secret side projects. See more of his work [here](https://linktr.ee/yunghsuanwu).
